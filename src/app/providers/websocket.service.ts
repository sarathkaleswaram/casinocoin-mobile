...
export class WebsocketService {
  ...
  public brmConnectionStatusSubscription: Subscription;
  public brmMessagesSubscription: Subscription;
  ...
  connect() {
    ...
    this.websocketConnection.connectionStatus.subscribe(numberConnected => {
